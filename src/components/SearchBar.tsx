...
function SearchBar({ search, setSearch }: { search: string, setSearch: (text: string) => void }) {
    ...
    return (
        <InputBox>
            <div className="grid grid-cols-[auto_1fr] items-center gap-2 input w-full">
                <button><label htmlFor="search"><Icon name="search" className="-ml-[3px]" /></label></button>
